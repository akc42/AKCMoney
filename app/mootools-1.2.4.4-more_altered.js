...
Form.Validator.addAllThese([
	...
	['validate-currency', {
		errorMsg: Form.Validator.getMsg.pass('currency'),
		test: function(element){
			// [-]1[##][,###]+[.##]
			// [-]1###+[.##]
			// [-]0.##
...
MooTools.lang.set('en-US', 'Form.Validator', {
	...
	currency:'Please enter a valid monetary amount. If you enter an (optional) decimal point then two digits must follow.',
