...
const debug = Debug('xactionclear');
...
export default async function(user, params, responder) {
  ...
  db.transaction(() => {
    ...
    debug('db version', v, 'params version', params.version, 'xaction', params.id);
    if (v === params.version) {
      ...
      logger('error', `Xaction Clear Version Error Disk:${v}, Param:${params.version}`)
    }
  })();
